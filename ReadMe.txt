...
If I added some code to the engine it should be on the bottom of cpp
...
-With more time and qa feedback the game balance would probably bring many more mechanics.
-The overall code architecture could be better adjusted, especially resource loading
